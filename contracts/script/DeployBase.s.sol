...
contract DeployBase is Script {
    ...
    function run() external {
        ...
        // 9. Set treasury address (owner acts as treasury initially)
        factory.setTreasury(owner);

        // 10. Set protocol address on registry (owner acts as protocol initially)
        registry.setProtocol(owner);

        // 11. Configure: link registry to factory for auto vault deployment
