...
contract AgentRegistryTest is Test {
    ...
    function test_registerAgent_success() public {
        uint256 agentId = registry.registerAgent(agent1, codeHash1, "Agent 1 metadata");
    ...
    function test_registerAgent_incrementsIds() public {
        uint256 id1 = registry.registerAgent(agent1, codeHash1, "Agent 1");
        uint256 id2 = registry.registerAgent(agent2, codeHash2, "Agent 2");
    ...
    function test_registerAgent_revertsOnDuplicateWallet() public {
        ...
        registry.registerAgent(agent1, codeHash2, "Agent 1 again");
    }

    // ── updateReputation ────────────────────────────────────────

    function test_updateReputation_success() public {
        uint256 agentId = registry.registerAgent(agent1, codeHash1, "Agent 1");
