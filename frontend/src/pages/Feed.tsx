...
const SIMULATED_EVENTS: Omit<ActivityEvent, "id" | "timestamp">[] = [
  ...
  { type: "repayment", agentId: "0x4d5e6f", agentName: "ContentGen-AI", amount: 1_800, message: "ContentGen-AI repaid $1,800 ahead of schedule" },
  { type: "revenue", agentId: "0xv4w5x6", agentName: "StableYield-Pro", amount: 220, message: "StableYield-Pro earned $220 from Compound yield" },
]
